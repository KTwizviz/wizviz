    ...
    <div className="pt-[74px] pb-[100px] w-[1100px] mx-auto">
      <div className="pt-10">
        ...
        <div className="pt-10 text-center">
          <p className="text-ELSE-EC0 text-3xl font-bold leading-relaxed tracking-normal text-left">
            복합 문화공간의 첨단 야구장! 수원구장
          </p>
          <div className="bg-ELSE-EC0 h-[3px] mt-6 mb-7 w-10"> </div>
        </div>
        <p className="text-ELSE-11 text-xl font-bold font-stretch-normal tracking-normal text-left ">
          최적의 경기 환경 조성
        </p>
        <p className="text-ELSE-B5B text-base font-normal font-stretch-normal leading-6 tracking-normal text-justify pt-4 pb-7">
      ...
      <div>
        ...
        <div>
          ...
          <p className="text-ELSE-B5B text-base font-normal font-stretch-normal leading-6 tracking-normal text-justify pt-4 pb-7">
            ...
            기기가 설치된 체험존 등을 제공하여 경기 관람 뿐 아니라 오락, 레저,
            교육의 복합 문화공간을 선보입니다.
          </p>
        </div>
      </div>
