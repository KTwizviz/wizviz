...
export { default as store_banner } from "./store_banner.jpg";
export { default as player_banner } from "./player_banner.jpg";
export { default as CarouselImage1 } from "./gallery1.jpg";
export { default as CarouselImage2 } from "./gallery2.jpg";
export { default as CarouselImage3 } from "./gallery3.jpg";
export { default as CarouselImage4 } from "./gallery4.jpg";
export { default as CarouselImage5 } from "./gallery5.jpg";
export { default as CarouselImage6 } from "./gallery6.jpg";
export { default as CarouselImage7 } from "./gallery7.jpg";
export { default as CarouselImage8 } from "./gallery8.jpg";
export { default as CarouselImage9 } from "./gallery9.jpg";
export { default as CarouselImage10 } from "./gallery10.jpg";
