    ...
    items: [
      {
        ...
        path: "ktwiz/about",
        title: "kt wiz는?",
        descript: "한국 프로야구의 '10번째 심장' kt wi를 소개합니다.",
      },
      {
        id: 2,
        path: "ktwiz/bi",
        title: "구단 BI",
        descript: "kt wiz를 대표하는 상징들을 소개 합니다.",
      },
      {
        id: 3,
        path: "ktwiz/policy",
        title: "회원 정책",
        descript: "kt wiz 회원만의 특별한 할인 혜택을 만나 보세요.",
      },
      {
        id: "4",
        path: "ktwiz/sponsor",
        title: "스폰서",
        descript: "kt wiz와 함께하는 스폰서를 소개합니다.",
      },
      {
        id: "wiz-news",
        path: "ktwiz/wallpaper",
        title: "월페이퍼",
        descript: "kt wiz 팬들을 위한 월페이퍼 다운로드 서비스",
      },
    ],
  },
  "wiz park": {
    ...
    items: [
      {
        ...
        descript: "suwon kt wiz park를 소개합니다.",
      },
      {
        id: 2,
      ...
      },
      {
        ...
        title: "찾아오기",
        descript: "오시는 길을 상세하게 알려드립니다.",
      },
      {
        id: 4,
        path: "wizpark/iksan",
        title: "익산야구장",
        descript: "kt wiz의 둥지 '익산야구장'을 소개합니다.",
      },
    ],
  },
  game: {
    ...
    items: [
      {
        ...
        title: "정규리그",
        descript: "kt wiz의 정규리그 경기 일정을 알려 드립니다.",
      },
    ],
  },
  player: {
    ...
    items: [
      {
        ...
        path: "player/coach",
        title: "코칭스텝",
        descript: "최고의 kt wiz 코칭스탭을 소개합니다.",
      },
      {
        id: 2,
        path: "player/pitcher",
        title: "투수",
        descript: "kt wiz의 자랑스런 ‘첫 번째 선수단’을 소개합니다.",
      },
      {
        id: 3,
